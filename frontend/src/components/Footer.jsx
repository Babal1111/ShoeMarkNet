      ...
      <footer className='bg-theme pt-7 pb-5 mt-10'>
        <div className='nike-container text-slate-200'>
          ...
          <div className='mt-5 text-center'>
            <p className='text-sm md:text-center'>Copyright<sup className='text-base font-bold'>&copy;</sup> All Reserved Rights <span className='font-semibold'>Vedant Lahane {Year}</span></p>
          </div>
        </div>
      </footer>
   </>
